    ...
    $(document).ready(function () {
        ...
        $("#nextStep2").click(function (event) {
            ...
            $("#daftar-pekerja-body tr").each(function () {
                ...
                let jabatanInput = row.find('input[name^="jabatan"]');
                let jabatan = jabatanInput.val()?.trim();
        ...
        $(document).on("click", ".hapus-pekerja", function () {
            ...
            let jabatan = row.closest('tbody').attr('id').replace('pekerja-list-', '');
            ...
            let remainingRows = $(`#pekerja-list-${jabatan} tr`).length;
            if (remainingRows === 0) {
                let emptyRow = `
                    <tr>
                        <td>
                ...
                `;
                $(`#pekerja-list-${jabatan}`).append(emptyRow);
            }
        });
                ...
                <tr>
                    ...
                    <td>
                        <div class="input-group">
                            ...
                            <button type="button" class="btn btn-danger btn-sm delete-row ms-2">
