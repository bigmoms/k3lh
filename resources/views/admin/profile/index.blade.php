                    ...
                    <div class="card">
                        <div class="card-body">
                            <ul class="nav nav-pills" id="profile-tab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active show" id="edit-profile-tab" data-toggle="tab"
                                        href="#edit-profile" role="tab" aria-controls="home"
                            ...
                            <div class="tab-content" id="profile-content">
                                ...
                                <div class="tab-pane fade" id="change-password" role="tabpanel"
                                    ...
                                    <form action="{{ route('user.change_password') }}" name="change_password" method="post"
                                        class="needs-validation" novalidate="">
                                        @csrf
                                        @method('PUT')
                                        <div class="row">
