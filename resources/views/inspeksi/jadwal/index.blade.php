...
@section('title', 'Data Jadwal Inspeksi')
@section('header', 'Data Jadwal Inspeksi')
@section('style')
            ...
            <div class="page-title">
                <div class="row">
                    <div class="col-sm-6 col-12">
                        <h2>Data Jadwal Inspeksi K3LH Tersedia</h2>
                    </div>
                    <div class="col-sm-6 col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Data Jadwal Inspeksi</li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            @if (!Auth::user()->divisiInspeksi()->exists())
                                <div class="mb-3">
                                    <a href="{{ route('inspeksi.jadwal.create') }}" class="btn btn-primary">Tambah Jadwal
                                        Inspeksi</a>
                                </div>
                            @endif
...
@section('scripts')
    ...
    <script>
        var fetchUrl = "{{ route('inspeksi.jadwal.fetch') }}";
        var currentStatus = 'dijadwalkan';
        var countUrl = "{{ route('inspeksi.jadwal.statusCount') }}";
    </script>
    <script>
